...
const CLIENT_ID = "444430614353-3o6fuahjd1m3oa6fq6523t1b54qv3kji.apps.googleusercontent.com"
const CLIENT_SECRET = "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"
const  REDIRECT_URI = "https://developers.google.com/oauthplayground"
const  REFRESH_TOKEN = "1//04JEVCdOI82ukCgYIARAAGAQSNwF-L9IrqnhbZrN6Zvl0KYnZB5KhzPawczewJjHPQY2_IalnzdhOL7TJxLNGoEiOjplTTgK8syI"
...
app.post("/mailapp", async (req, res) => {
  ...
  try {
    ...
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        type: "OAuth2",
        user: "chauhanvivek1750@gmail.com",
        clientId: CLIENT_ID,
    ...
    let mailOptions = {
      from: 'chauhanvivek1750@gmail.com',
      to: to,
